...
import com.gaea.gamemaster.Report.ReportHtml;
import com.gaea.gamemaster.mobile.AppiumManager;
import com.gaea.gamemaster.publicTool.*;
...
public class LFSandroid {
    ...
    private static String casePath = FileManage.dzxyCasePath;
    ...
    public static void doAppium() throws Exception {
        ...
        reportHtml.doHtmlReport(caseNum(casePath));
    ...
    private static void runSceneCase(FileWriter pfp) throws Exception {
        ...
        int sceneNum = ExcelTest.getRows(casePath, sceneManagerName);
        getScene(sceneManagerName, casePath);
...
/*        driver.quit();
    ...
    private static void runScene(AppiumDriver driver, String runSceneName, FileWriter pfp) throws Exception {
        ...
        int rows = ExcelTest.getRows(casePath, runSceneName);
        getCaseValue(runSceneName, casePath);
